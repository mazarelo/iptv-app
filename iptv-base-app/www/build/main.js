...
var Splash = (function () {
    ...
    Splash = __decorate([
        Object(__WEBPACK_IMPORTED_MODULE_0__angular_core__["m" /* Component */])({
            selector: 'page-splash',template:/*ion-inline-start:"/home/mazarelo/Work/iptv-app/iptv-base-app/src/pages/splash/splash.html"*/'<ion-content>\n \n    <img src="assets/imgs/splash-screen.png"/>\n \n</ion-content>'/*ion-inline-end:"/home/mazarelo/Work/iptv-app/iptv-base-app/src/pages/splash/splash.html"*/,
        }),
...
var ChannelsPage = (function () {
    ...
    ChannelsPage = __decorate([
        Object(__WEBPACK_IMPORTED_MODULE_0__angular_core__["m" /* Component */])({
            selector: 'channels',template:/*ion-inline-start:"/home/mazarelo/Work/iptv-app/iptv-base-app/src/pages/channels/channels.html"*/'<ion-header>\n    <ion-navbar>\n      <ion-title>{{title}}</ion-title>\n    </ion-navbar>\n  </ion-header>\n  <ion-content>\n      <ion-searchbar (ionInput)="onInput($event)"></ion-searchbar>\n    <ion-list >\n      <ion-item \n        *ngFor="let channel of channels; let i = index" \n        (click)="presentActionSheet(i)"\n        [style.background]="\'url(assets/imgs/fallback.png)\'" \n        [style.backgroundSize]="\'contain\'" \n        [style.backgroundPosition]="\'center center\'" \n        [style.backgroundRepeat]="\'no-repeat\'">\n\n        <ion-thumbnail item-start \n          [style.background]="\'url(\'+ channel.tvLogo +\')\'" \n          [style.backgroundSize]="\'contain\'" \n          [style.backgroundPosition]="\'center center\'" \n          [style.backgroundRepeat]="\'no-repeat\'">\n        </ion-thumbnail>\n        <h2>{{channel.tvName}}</h2>\n        <!--<button ion-button clear item-end (click)="playChannel(channel.url)">View</button>-->\n      </ion-item>\n    </ion-list>\n    <ion-infinite-scroll (ionInfinite)="doInfinite($event)">\n        <ion-infinite-scroll-content></ion-infinite-scroll-content>\n    </ion-infinite-scroll>\n</ion-content>\n'/*ion-inline-end:"/home/mazarelo/Work/iptv-app/iptv-base-app/src/pages/channels/channels.html"*/
        }),
...
var MyApp = (function () {
    ...
    MyApp = __decorate([
        Object(__WEBPACK_IMPORTED_MODULE_0__angular_core__["m" /* Component */])({template:/*ion-inline-start:"/home/mazarelo/Work/iptv-app/iptv-base-app/src/app/app.html"*/'<ion-menu [content]="content">\n    <ion-header>\n      <ion-toolbar>\n        <ion-title>IPTV</ion-title>\n        <button ion-button menuToggle>\n            <ion-icon name="close"></ion-icon>\n        </button>\n      </ion-toolbar>\n    </ion-header>\n  \n    <ion-content>\n      <ion-list>\n          <ion-item menuClose ion-item *ngFor="let p of pages" (click)="openPage(p)">\n            <ion-icon name="{{p.icon}}" item-start></ion-icon>\n            {{p.title}}\n          </ion-item>\n      </ion-list>\n    </ion-content>\n  \n  </ion-menu>\n  \n  <!-- Disable swipe-to-go-back because it\'s poor UX to combine STGB with side menus -->\n  <ion-nav [root]="rootPage" #content swipeBackEnabled="false"></ion-nav>'/*ion-inline-end:"/home/mazarelo/Work/iptv-app/iptv-base-app/src/app/app.html"*/
        }),
...
var TabsPage = (function () {
    ...
    TabsPage = __decorate([
        Object(__WEBPACK_IMPORTED_MODULE_0__angular_core__["m" /* Component */])({template:/*ion-inline-start:"/home/mazarelo/Work/iptv-app/iptv-base-app/src/pages/tabs/tabs.html"*/'<ion-tabs>\n  <ion-tab [root]="tab1Root" tabTitle="Channels" tabIcon="film"></ion-tab>\n  <ion-tab [root]="tab2Root" tabTitle="Favorites" tabIcon="star"></ion-tab>\n  <ion-tab [root]="tab3Root" tabTitle="Settings" tabIcon="settings"></ion-tab>\n</ion-tabs>\n'/*ion-inline-end:"/home/mazarelo/Work/iptv-app/iptv-base-app/src/pages/tabs/tabs.html"*/
        }),
